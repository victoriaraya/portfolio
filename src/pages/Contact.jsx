const Contact = () => {
  return (
    <div className="h-screen w-screen mt-0 sm:pt-9 bg-[#b291a4]">
      <div className="flex flex-col sm:flex-row gap-5 h-full w-full">
        <div className="flex flex-col justify-start text-center sm:text-start pt-6 sm:pt-0 px-8 sm:px-0 sm:pl-20 self-center text-white text-3xl w-full sm:w-[400px] sm:animate-slide-right-delay">
          <p className="w-full">
